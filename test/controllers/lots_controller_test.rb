...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { farm_id: @lot.farm_id, location: @lot.location, name: @lot.name } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { farm_id: @lot.farm_id, location: @lot.location, name: @lot.name } }
